...
def plot_FC_matrix(FC_matrix, title="Functional Connectivity Matrix", cmap="turbo", size=1.5):
    """
    Plots a functional connectivity matrix as a heatmap.
    ...
    plt.imshow(FC_matrix, cmap)  # 'bwr' for positive and negative values
