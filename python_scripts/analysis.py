...
I_norm1_group = np.array(get_field(all_values, "I_norm1", filters={"level": "group"}))
I_norm2_group = np.array(get_field(all_values, "I_norm2", filters={"level": "group"}))
I_tmax_sub = np.array(get_field(all_values, "I_tmax", filters={"level": "subject"}))
I_norm1_sub = np.array(get_field(all_values, "I_norm1", filters={"level": "subject"}))
